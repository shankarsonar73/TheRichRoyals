        ...
        <div className="flex flex-wrap gap-10 mb-10">
          {benefits.map((item) => (
            <div
              ...
              key={item.id}
            >
              {/* Remove pointer-events-none to enable interactions */}
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem]">
                ...
                <div className="flex items-center mt-auto">
                  <img
                    ...
                    alt={item.title}
                  />
                  {/* Wrap 'Explore More' and Arrow in an anchor tag */}
                  <a
                    href={item.link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="ml-auto flex items-center text-n-1 hover:underline"
                  >
                    <p className="font-code text-xs font-bold uppercase tracking-wider">
                      Explore more
                    </p>
                    <Arrow />
                  </a>
