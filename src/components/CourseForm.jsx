...
<h2 className="text-2xl font-bold mt-10 text-white text-center">
    Create a New Course Offer Banner
  </h2>
<form
  onSubmit={handleSubmit}
  className="space-y-6 max-w-md mx-auto p-6 bg-black m-10 rounded-lg shadow-lg"
>
  <div>
  ...
  <div>
    <label className="block text-sm font-medium text-white">Course Image</label>
